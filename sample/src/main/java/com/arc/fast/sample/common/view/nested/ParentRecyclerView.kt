package com.arc.fast.sample.common.view.nested
...
class ParentRecyclerView @JvmOverloads constructor(
    ...
    private fun doNotInterceptTouch(rawY: Float, childRecyclerView: ChildRecyclerView?): Boolean {
        if (null != childRecyclerView &&
            ...
            if (rawY > childRecyclerViewY && rawY < childRecyclerViewY + childRecyclerView.height) {
                return true
            }
...
//                        }
//                    } else {
//                        if (dy > (childPagerContainer!!.top - stickyHeight)) {
//                            childPagerContainer!!.top - stickyHeight
//                        } else {
//                            dy
//                        }
//                    }
...
//                }
            ...
            Log.e(
                "aaaaaaaaaaa",
                "aaaaaa:dy:" + dy + ",childScrollY:" + childScrollY + ",consumeY:" + consumeY
            )
            Log.e(
                "aaaaaaaaaaa",
                "aaaaaa:top:" + childPagerContainer!!.top + ",bottom:" + childPagerContainer!!.bottom
            )
            if (consumeY != 0) {
                consumed[1] = consumeY
...
//                val dy = t - oldt
//                if ((dy > 0 && it.top - dy <= stickyHeight) ||
//                    (dy < 0 && it.top - dy >= stickyHeight)
//                ) {
//                    findCurrentChildRecyclerView()?.fling(0, getVelocityY())
//                    this.stopFling()
//                }
//            }
//        }
